...
<div class="container-fluid px-4 mt-4"> 
   <div class="card mb-4 border-start border-primary border-4 shadow-sm"> 
       <div class="card-body"> 
           <h2 class="h4 mb-1 fw-bold text-dark">Emitir Receituário Clínico — {{ $animal->name }}</h2> 
           <p class="text-muted mb-0">Tutor Responsável: {{ $animal->tutor->name }}</p> 
       </div> 
   </div> 
...
{{-- MOTOR JAVASCRIPT DE DINAMISMO DO RECEITUÁRIO --}} 
<script> 
document.addEventListener('DOMContentLoaded', function () { 
   ...
   function reindexBlocks() { 
       ...
       blocks.forEach((block, index) => { 
           ...
           // Renomeia os inputs para não quebrar o array bidimensional do PHP/Request 
